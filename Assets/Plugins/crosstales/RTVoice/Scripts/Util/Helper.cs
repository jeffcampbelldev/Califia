...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Helper : Common.Util.BaseHelper
   {
      ...
      public static bool hasBuiltInTTS => isWindowsBasedPlatform || isAppleBasedPlatform || isAndroidPlatform || isLinuxPlatform; //|| Speaker.isCustomMode && Speaker.CustomVoiceProvider != null && Speaker.CustomVoiceProvider.isPlatformSupported;
      ...
      public static Model.Enum.ProviderType CurrentProviderType
      {
         get
         {
            if (Speaker.Instance.MaryTTSMode)
