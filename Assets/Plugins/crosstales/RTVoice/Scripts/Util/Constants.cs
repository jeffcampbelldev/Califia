...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2020.4.3";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20201018;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2020, 10, 19);
      ...
      public const string DEFAULT_TTS_LINUX = "C:\\Program Files (x86)\\eSpeak\\command_line\\espeak.exe"; // eSpeak under Windows
